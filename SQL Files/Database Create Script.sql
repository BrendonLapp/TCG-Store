...
ALTER TABLE CardsInSet
	ADD CONSTRAINT FK_YugiohID FOREIGN KEY (YugiohID) REFERENCES Yugioh;
ALTER TABLE CardsInSet
	ADD CONSTRAINT PK_CardsInSet PRIMARY KEY (CardSetNumber);

CREATE TABLE Inventory (
	InventoryID INT NOT NULL IDENTITY(70000000,1),
	CardSetNumber VARCHAR(10) NULL,
...
ALTER TABLE Inventory
	ADD CONSTRAINT FK_CardSetNumber FOREIGN KEY(CardSetNumber) REFERENCES CardsInSet(CardSetNumber);
ALTER TABLE Inventory
